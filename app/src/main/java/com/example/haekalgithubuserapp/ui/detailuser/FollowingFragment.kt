...
import com.example.haekalgithubuserapp.databinding.FragmentFollowingBinding
...
/**
 * Class that organize Following tab in TabLayout.
 */
class FollowingFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        userDetailViewModel.followingList.observe(this, { followerList ->
            followerList?.let { setFollowingList(it) }
        })
        userDetailViewModel.showFollowingList(userId.toString())
    }
    ...
    private fun setFollowingList(items: List<FollowResponseItem>) {
